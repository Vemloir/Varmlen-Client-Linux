...
const EN: Dict = {
  ...
  "menu.ping": "Ping",
  "menu.pinLocation": "Pin location",
  "menu.unpinLocation": "Unpin location",
  "menu.hide": "Hide location",
  "menu.unhide": "Show location again",
  "menu.deleteLocation": "Delete location",
  ...
  "split.noAppsHint": "Add apps from the ones you have installed, or choose one by file.",
  "split.sitePlaceholder": "example.com or .ru",
  "split.noSitesTitle": "No websites yet",
  "split.noSitesHint": "A domain (example.com) or a zone (.ru).",
  // Plural: the picker is multi-select, one press does not add one app.
  "split.addApp": "Add apps",
  "split.addSites": "Add websites",
  "split.presetRegion": "By region",
  "split.presetServices": "Popular services",
  "split.siteInvalid": "Not a domain or a zone.",
  "split.siteExactOnly": "Only this domain",
  "split.siteExactOnlyHint": "No subdomains",
  "split.siteExactNeedsHost": "“Only this domain” needs a domain, not a zone.",
  "split.siteKindSuffix": "and subdomains",
  "split.siteKindZone": "whole zone",
  "split.siteKindExact": "this host only",
  "split.siteNotationHint":
    "A name covers the domain and everything under it; .ru covers a whole zone.",
  "split.noSitePresets": "Everything suggested is already listed.",
  ...
  "settings.mtu": "MTU",
  "settings.mtuSub": "Packet size on the tunnel interface.",
  "settings.pingMethod": "Ping method",
  "settings.pingMethodSub": "How server latency is measured.",
  "settings.navLabels": "Tab labels",
  "settings.navLabelsSub": "Show the name under each tab icon.",
  "settings.pinOrder": "Pinned locations",
  "settings.pinOrderSub": "Order of the pinned locations.",
  "settings.pinOrder.newestLast": "Newest pinned at the end",
  "settings.pinOrder.newestFirst": "Newest pinned first",
  "settings.pingConcurrency": "Simultaneous pings",
  "settings.pingConcurrencySub":
    "0 means no limit. Every probe is its own short-lived xray process.",
...
const RU: Dict = {
  ...
  "menu.ping": "Пинг",
  "menu.pinLocation": "Закрепить локацию",
  "menu.unpinLocation": "Открепить локацию",
  "menu.hide": "Скрыть локацию",
  "menu.unhide": "Показать локацию снова",
  "menu.deleteLocation": "Удалить локацию",
  ...
  "split.noAppsHint": "Добавьте приложения из установленных или выберите файл.",
  "split.sitePlaceholder": "example.com или .ru",
  "split.noSitesTitle": "Пока нет сайтов",
  "split.noSitesHint": "Домен (example.com) или зона (.ru).",
  "split.addApp": "Добавить приложения",
  "split.addSites": "Добавить сайты",
  "split.presetRegion": "По зонам",
  "split.presetServices": "Популярные сервисы",
  "split.siteInvalid": "Это не домен и не зона.",
  "split.siteExactOnly": "Только этот домен",
  "split.siteExactOnlyHint": "Без поддоменов",
  "split.siteExactNeedsHost": "«Только этот домен” требует домен, а не зону.",
  "split.siteKindSuffix": "и поддомены",
  "split.siteKindZone": "вся зона",
  "split.siteKindExact": "только этот хост",
  "split.siteNotationHint":
    "Имя покрывает домен и всё под ним; .ru покрывает зону целиком.",
  "split.noSitePresets": "Все предложенные записи уже в списке.",
  ...
  "settings.mtu": "MTU",
  "settings.mtuSub": "Размер пакета на туннельном интерфейсе.",
  "settings.pingMethod": "Метод пинга",
  "settings.pingMethodSub": "Как измеряется задержка серверов.",
  "settings.navLabels": "Подписи вкладок",
  "settings.navLabelsSub": "Показывать подпись под иконкой вкладки.",
  "settings.pinOrder": "Закреплённые локации",
  "settings.pinOrderSub": "Порядок закреплённых локаций.",
  "settings.pinOrder.newestLast": "Свежие закрепления в конце",
  "settings.pinOrder.newestFirst": "Свежие закрепления первыми",
  "settings.pingConcurrency": "Одновременных пингов",
  "settings.pingConcurrencySub":
    "0 — без ограничения. Каждая проба — отдельный процесс xray.",
