...
const EN: Dict = {
  ...
  "home.trafficNone": "No traffic data",
  ...
  "split.addSites": "Add website",
  "split.siteDuplicate": "Already in the list.",
...
const RU: Dict = {
  ...
  "info.traffic": "Трафик",
  "home.trafficNone": "Нет данных о трафике",
  ...
  "split.addSites": "Добавить сайт",
  "split.siteDuplicate": "Уже в списке.",
