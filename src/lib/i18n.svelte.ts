...
const EN: Dict = {
  ...
  "split.noSitesHint": "A hostname (example.com) or a wildcard pattern (*.example.com).",
  ...
  "split.siteInvalid": "Not a domain or a *.domain pattern.",
...
const RU: Dict = {
  ...
  "split.noSitesHint": "Домен (example.com) или шаблон (*.example.com).",
  ...
  "split.siteInvalid": "Это не домен и не шаблон *.домен.",
