...
const EN: Dict = {
  ...
  "settings.hideLocations": "Hide locations",
  ...
  "settings.hideMode.always": "Until I show it again",
  "settings.hideMode.off": "Never hide",
  "settings.pinOrder": "Pinned locations",
  "settings.pinOrderSub": "Order of pinned locations. Never by latency.",
...
const RU: Dict = {
  ...
  "settings.hideMode.always": "Пока сам не покажу",
  "settings.hideMode.off": "Не скрывать",
  "settings.pinOrder": "Закреплённые локации",
  "settings.pinOrderSub": "Порядок закреплённых. По задержке — никогда.",
